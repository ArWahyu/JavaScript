...
const FormEditProduct = () => {
  ...
  useEffect(() => {
    const getProductById = async () => {
      try {
        ...
        setTanggalMasukKerja(response.data.tanggalMasukKerja);
        setJabatan(response.data.jabatan);
        setPekerjaan(response.data.pekerjaan);
        setGollongan(response.data.golongan);
        setGreate(response.data.greate);
        setMutasi(response.data.mutasi);
  ...
  return (
    <div>
      ...
      <h2 className="subtitle">Edit Data Karyawan</h2>
